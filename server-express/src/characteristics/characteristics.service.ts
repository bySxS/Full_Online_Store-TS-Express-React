...
class CharacteristicsService implements ICharacteristicService {
  ...
  /* ToDo: сделать функцию получения доступных названий хакактеристик
   *   для категорий по id понадобится при добавлении нового продукта и редактировании
   */

  /* ToDo: сделать функцию для выгрузки всех характеристик
